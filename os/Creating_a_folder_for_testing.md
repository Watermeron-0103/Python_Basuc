...
- 指定のファイルからシート名を選択し、シート名が含まれているフォルダをsearch_dirから読み込み、シート名でoutput_parentにフォルダを作成する
    ...
    output_parent = r"C:\Users\11064667.FFWIN\OneDrive - FUJIFILM\02. 検査計画書\★赤坂確認"
...
- 指定のファイルからシート名を選択し、シート名が含まれているファイルをsearch_dirから読み込み、シート名でoutput_parentにフォルダを作成する
    ```python
    import os
    import shutil
    import pandas as pd
