...
output_parent = r"C:\Users\11064667.FFWIN\OneDrive - FUJIFILM\I_検査計画書\★赤坂確認"
...
label = ttk.Label(root, text="Select your seat!:")
label.pack(pady=5)
...
def make_folder_and_move():
    ...
    # --- ここまで ---
    messagebox.showinfo("完了", f"フォルダを作成＆copytreeしました：\n{full_folder_path}")

button = ttk.Button(root, text="Creating & copying folders", command=make_folder_and_move)
button.pack(pady=10)
